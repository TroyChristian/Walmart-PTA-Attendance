...
path('tracker', views.attendance_tracker_view, name="tracker"),
...
# this is the orginal one the link below is for development with no database path('associates/<int:associate_pk>', views.associate_detail_view, name="associate_detail"),
...
path('baseTwo', views.baseTwo, name="basetwo"),
